...
public class Token {
	...
	protected void setTermText(String text) {
		termText = (text != null) ? text.trim().toLowerCase() : text;
	...
	protected void merge(Token...tokens) {
		if(tokens != null){
			...
			for(Token token: tokens){
				addendum.append(" " + token.getTermText());
			}
			setTermText(this.termText.concat(addendum.toString()));
		}
	}
	...
	public String toString() {
		return this.getTermText().toString();
	}
